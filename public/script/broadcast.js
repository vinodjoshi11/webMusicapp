...
var broadcast = function(config) {
    ...
    return {
        createRoom: function(_config) {
            ...
            var user=self.roomName;
            $("#userName").html(self.roomName);
            arrUserList.push(user)
            user='';

            /*var add_input_grp = $("conference-name").val();

            arrUserList.push(add_input_grp);
            var add_input_grp = $("conference-name").val('');*/

            /*console.log(arrUserList.length);
            console.log(JSON.stringify(arrUserList))*/
            localStorage.setItem('UserName',JSON.stringify(arrUserList))
            isbroadcaster = true;
            isGetNewRoom = false;
